                    ...
                    <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
                        <li className="my-2 my-lg-0 nav-item dropdown">
                            ...
                            <div className="dropdown-menu" aria-labelledby="dropdownId">
                                <NavLink className="dropdown-item" to='/todolistRFC'>Join classroom</NavLink>
                                <NavLink className="dropdown-item" to='/' data-toggle="modal" data-target="#modelId">Create classroom</NavLink>
                            </div>
                        </li>
                    </ul>
